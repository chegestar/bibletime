This boundle use
	...
	sword, it is linked as static library, it is slightly modified for wince platform
	qt, is slightly modified for wince platform
cmake is used to generate projects to build sword library
	for wince it is modified cmake version that is able to generate projects for this platform (it is in public access)
